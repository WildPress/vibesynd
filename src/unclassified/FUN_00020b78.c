/* frameless @ 0x20b78: for the current row g_10b16, count the leading nonzero word
   ...
   straight into DL. (2) INC pair count(CH)/i(CL) transposed. (3) return-load vs g_10b16
