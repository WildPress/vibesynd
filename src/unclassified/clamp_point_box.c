/* frameless @ 0x1ba48: clamp a point (param_1,param_2) into the bounding box
   ...
   iso_block_dispatch2(x+i, y+i, 0x10, g_marker_phase_b, i); finish with fill_minimap_grid().
...
void clamp_point_box(short param_1, short param_2)
{
    ...
    for (i = 0; i < 0x19; i++)
        iso_block_dispatch2((short)(g_map_cursor_x + i), (short)(g_map_cursor_y + i), 0x10, g_marker_phase_b, i);
    fill_minimap_grid();
}
