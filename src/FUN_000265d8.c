/* frameless @ 0x265d8: stats-panel drawer for record p in the 10-byte table at
   ...
   drawer). If owner==g_10b16 with a live claim (word!=0xff), draws two button
