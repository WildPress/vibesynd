/* frameless @ 0x22ba8: spawn into the g_11670 pool (records of 0x24 bytes). Scan for a
   ...
   slot. Sibling of FUN_0001c178. Bounds are EXTERN symbols so the loop cmp isn't folded. */
...
unsigned short *FUN_00022ba8(unsigned short param_1, unsigned short param_2, unsigned short param_3)
{
