/* frameless @ 0x1a918: mark a clamped rectangle of the minimap grid g_db2c with 3.
   ...
   param_1..param_3 and col param_2..param_4 set g_db2c[row + col*0x10]=3. (param_3 stays
   on the stack; the other three coords live in EBX/EDI/ESI.) */
extern unsigned char g_db2c[];
void FUN_0001a918(short param_1, short param_2, short param_3, short param_4)
{
    short row, col;
