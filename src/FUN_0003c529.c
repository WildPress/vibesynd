/* C runtime: fd->stream lookup @ 0x3c529 (CLIB3S, Watcom 9.5). Returns the stream table
   ...
   with isatty (FUN_0003c44d): marks 0x40, and on a tty also marks 0x20. Out-of-range fd
...
#pragma aux __fdstream = "db 139" "db 117" "db 16" "db 59" "db 53" "db 40" "db 192" "db 0" "db 0" "db 114" "db 4" "db 49" "db 192" "db 235" "db 58" "db 131" "db 254" "db 5" "db 127" "db 45" "db 137" "db 243" "db 161" "db 124" "db 192" "db 0" "db 0" "db 193" "db 227" "db 2" "db 246" "db 68" "db 3" "db 1" "db 64" "db 117" "db 28" "db 86" "db 128" "db 76" "db 3" "db 1" "db 64" "call FUN_0003c44d" "db 131" "db 196" "db 4" "db 133" "db 192" "db 116" "db 10" "db 161" "db 124" "db 192" "db 0" "db 0" "db 128" "db 76" "db 24" "db 1" "db 32" "db 161" "db 124" "db 192" "db 0" "db 0" "db 139" "db 4" "db 176" parm [] value [eax] modify exact [eax ebx esi];

int FUN_0003c529(int fd)
{
    return __fdstream();
}
