/* FUN_00024be8 @ 0x24be8 (1395B) - command-line / startup parser ("main" arg loop).
 *
...
extern void FUN_0003adb2(int inter, void *in, void *out);   /* int386 */
extern void FUN_0003af38(void *s);
extern long FUN_0003a526(char *s);                          /* atol */
extern int  FUN_00024b08(char *s);                          /* hex parse */
...
extern void FUN_00018338(char *p);
extern void FUN_000253a8(unsigned char *start, unsigned char *end, int arg3);
extern void FUN_00025338(void);
extern void FUN_00034c28(void);
extern int  FUN_00035d08(unsigned short a, unsigned short b, unsigned short c);
extern int  FUN_00038cf8(int a1, int a2, unsigned short a, unsigned short b, unsigned short c);
extern void FUN_0001c168(void);
extern void FUN_00025238(void);
...
void FUN_00024be8(short argc, char **argv)
{
    char cmdbuf[0x64];
    int  buf[7];
    short i;
    ...
    *(struct s12 *)cmdbuf = *(struct s12 *)g_355c;
        ...
        if (argv[i][0] == '/' || argv[i][0] == '-') {
            ...
            case 'i':
                ...
                if (argv[i][2] == 'i' && argv[i][3] == 'o')
                    g_4d98 = (unsigned short)FUN_00024b08(argv[i] + 4);
                break;
            case 'L':
            case 'l':
                g_105 = 4;
    ...
    FUN_000253a8(g_5308, g_530c, g_5310);
    g_5324 = g_5308 + 6;
    g_506c = 1;
    FUN_00025338();
    FUN_00034c28();
    ...
    if (g_10b4a != 0)
        g_10b4a = (unsigned char)FUN_00035d08(g_4d94, g_4d96, g_4d98);
    if (g_10b49 != 0)
        g_10b49 = (unsigned char)FUN_00038cf8((int)g_3594, (int)g_3584, g_4d94, g_4d96, g_4d98);
