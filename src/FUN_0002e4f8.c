/* frameless @ 0x2e4f8: search up to 4 directions for a valid projectile step.
   ...
   obj[4]/obj[6] offset by the signed direction tables g_ab60 (x) / g_ad60 (y)
...
void FUN_0002e4f8(unsigned char *obj, unsigned char param_2)
{
    ...
    for (i = 0; i < 4; i++) {
        if ((short)FUN_0002d5b8(
                (short)(*(short *)(obj + 4) + (g_ab60[local_10] * obj[0x54] >> 8)),
                (short)((g_ad60[local_10] * obj[0x54] >> 8) + *(short *)(obj + 6)),
                *(short *)(obj + 8),
                obj) != 0)
            break;
        local_10 -= param_2;
