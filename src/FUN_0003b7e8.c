...
#pragma aux __db_0003b7e8_1 = "db 182" "db 0" "db 80" "call FUN_0003da37" "db 131" "db 196" "db 4" "db 136" "db 69" "db 252" "db 60" "db 114" "db 117" "db 49" "db 49" "db 192" "db 246" "db 67" "db 12" "db 2" "db 116" "db 5" "db 184" "db 2" "db 0" "db 0" "db 0" "db 246" parm [] modify exact [eax ebx ecx edx esi edi];
...
#pragma aux __db_0003b7e8_6 = "db 255" "db 117" "db 13" "db 83" "call FUN_0003dae1" "db 131" "db 196" "db 4" "db 49" "db 192" "db 235" "db 22" "db 49" "db 192" "db 137" "db 67" "db 4" "db 137" "db 67" "db 8" "db 83" "db 137" "db 67" "db 20" "call FUN_0003db36" "db 131" "db 196" "db 4" parm [] modify exact [eax ebx ecx edx esi edi];
