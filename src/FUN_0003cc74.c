/* C runtime: system() / spawn-command @ 0x3cc74 (CLIB3S, Watcom 9.5). Large framed
   ...
   string ptrs 0x3d58.. via FUN_0003aef9/FUN_0003a8d7/FUN_0003cba4), spawns through the
...
extern void FUN_0003aef9(void);
extern void FUN_0003cc26(void);
extern void FUN_0003cc45(void);
extern void FUN_0003a8d7(void);
...
#pragma aux __FUN_0003cc74_5 = "db 83" "call FUN_0003e381" "db 131" "db 196" "db 20" "call FUN_0003c46d" "db 199" "db 0" "db 1" "db 0" "db 0" "db 0" "db 139" "db 69" "db 34" "db 128" "db 56" "db 0" "db 116" "db 98" "db 128" "db 125" "db 86" "db 0" "db 116" "db 7" "db 184" "db 91" "db 61" "db 0" "db 0" "db 235" "db 5" "db 184" "db 96" "db 61" "db 0" "db 0" "db 80" "db 255" "db 117" "db 34" "call FUN_0003aef9" "db 131" "db 196" "db 8" "db 133" "db 192" "db 117" "db 27" "db 190" "db 255" "db 255" "db 255" "db 255" "db 83" "call FUN_0003cc26" "db 131" "db 196" "db 4" "db 133" "db 192" modify exact [eax ebx ecx edx esi edi ebp];
...
#pragma aux __FUN_0003cc74_9 = "call FUN_0003a8d7" "db 131" "db 196" "db 8" "db 83" "call FUN_0003cc26" "db 131" "db 196" "db 4" "db 133" "db 192" "db 116" "db 105" "db 255" "db 117" "db 82" "call FUN_0003ab59" "db 131" "db 196" "db 4" "db 199" "db 69" "db 82" "db 0" "db 0" "db 0" "db 0" "db 106" "db 1" "db 255" "db 117" "db 54" "db 255" "db 117" "db 122" "db 83" "call FUN_0003e143" "db 131" "db 196" "db 16" "db 106" "db 0" "db 255" "db 117" "db 54" "db 83" "db 15" "db 182" "db 69" "db 86" "db 80" "db 141" "db 69" "db 50" "db 80" "call FUN_0003cbf9" "db 131" "db 196" "db 8" "db 80" modify exact [eax ebx ecx edx esi edi ebp];
