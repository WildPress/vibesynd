/* frameless @ 0x35f28: conditionally record a max value. If g_5350[param_1*0x20 + 0x1e]
...
void FUN_00035f28(unsigned char param_1, unsigned char param_2)
{
    if (g_5350[param_1 * 0x20 + 0x1e] != 0) {
        int i = param_1 * 2;
        if (g_11bec[i] != 0) {
