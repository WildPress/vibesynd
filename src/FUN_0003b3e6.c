/* C runtime: int386x @ 0x3b3e6 (CLIB3S, Watcom 9.5). Register-setup wrapper for a
   ...
   out, sregs) into ESI/EDI/EDX/EBX, calls the core int dispatcher FUN_0003d4bc,
...
extern void FUN_0003d4bc(void);
extern int __int386x(void);
#pragma aux __int386x = "db 83" "db 86" "db 87" "db 85" "db 137" "db 229" "db 139" "db 117" "db 20" "db 139" "db 125" "db 24" "db 139" "db 85" "db 28" "db 139" "db 93" "db 32" "call FUN_0003d4bc" "db 139" "db 69" "db 28" "db 139" "db 0" "db 93" "db 95" "db 94" "db 91" parm [] value [eax] modify exact [eax ecx edx];
