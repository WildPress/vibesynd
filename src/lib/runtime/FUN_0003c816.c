...
#pragma aux __c816_0 = "db 83" "db 86" "db 85" "db 137" "db 229" "db 139" "db 117" "db 16" "db 131" "db 61" "db 172" "db 194" "db 0" "db 0" "db 254" "db 117" "db 7" "db 49" "db 192" "db 233" "db 219" "db 1" "db 0" "db 0" "db 131" "db 198" "db 3" "db 102" "db 131" "db 230" "db 252" "db 133" "db 246" "db 116" "db 238" "db 128" "db 61" "db 218" "db 194" "db 0" "db 0" "db 1" "db 116" "db 9" "db 128" "db 61" "db 218" "db 194" "db 0" "db 0" "db 9" "db 117" "db 5" "db 131" "db 198" "db 8" "db 235" "db 7" "call FUN_0003c74f" "db 41" "db 198" "db 141" "db 70" "db 32" "db 57" "db 240" "db 114" "db 201" "db 137" "db 198" "db 59" "db 5" "db 240" "db 194" "db 0" "db 0" "db 115" "db 10" "db 139" "db 53" "db 240" "db 194" "db 0" "db 0" "db 102" "db 131" "db 230" "db 254" "db 128" "db 61" "db 218" "db 194" "db 0" "db 0" "db 1" "db 116" "db 9" modify exact [eax ebx ecx edx esi edi ebp];
