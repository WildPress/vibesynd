...
extern void rnc_read_be_len(void);
extern void rnc_read_huffman(void);
extern void rnc_input_bits(void);
extern void rnc_make_huffman(void);
...
#pragma aux __drv_a = "db 85" "db 139" "db 236" "db 86" "db 87" "db 30" "db 6" "db 252" "db 30" "db 7" "db 139" "db 117" "db 8" "db 102" "db 173" "db 102" "db 61" "db 82" "db 78" "db 15" "db 133" "db 91" "db 1" "db 0" "db 0" "db 102" "db 173" "db 102" "db 61" "db 67" "db 1" "db 15" "db 133" "db 79" "db 1" "db 0" "db 0" "call rnc_read_be_len" "db 163" "db 176" "db 191" "db 0" "db 0" "call rnc_read_be_len" "db 163" "db 180" "db 191" "db 0" "db 0" "db 138" "db 94" "db 5" "db 136" "db 29" "db 192" "db 191" "db 0" modify exact [eax ebx ecx edx esi edi ebp];
...
#pragma aux __drv_c = "db 243" "db 165" "db 131" "db 198" "db 4" "db 131" "db 199" "db 4" "db 102" "db 139" "db 13" "db 180" "db 191" "db 0" "db 0" "db 102" "db 131" "db 225" "db 3" "db 103" "db 227" "db 6" "db 78" "db 79" "db 243" "db 164" "db 70" "db 71" "db 252" "db 139" "db 247" "db 139" "db 125" "db 12" "db 198" "db 5" "db 193" "db 191" "db 0" "db 0" "db 0" "db 102" "db 139" "db 6" "db 102" "db 163" "db 188" "db 191" "db 0" "db 0" "db 176" "db 2" "call rnc_input_bits" "db 186" "db 48" "db 190" "db 0" modify exact [eax ebx ecx edx esi edi ebp];
#pragma aux __drv_d = "db 0" "call rnc_make_huffman" "db 186" "db 176" "db 190" "db 0" "db 0" "call rnc_make_huffman" "db 186" "db 48" "db 191" "db 0" "db 0" "call rnc_make_huffman" "db 176" "db 16" "call rnc_input_bits" "db 102" "db 163" "db 186" "db 191" "db 0" "db 0" "db 235" "db 42" "db 186" "db 176" "db 190" "db 0" "db 0" "call rnc_read_huffman" "db 102" "db 81" "db 186" "db 48" "db 191" "db 0" "db 0" "call rnc_read_huffman" "db 102" "db 131" "db 193" "db 2" "db 51" "db 192" "db 102" "db 88" "db 102" "db 64" "db 139" modify exact [eax ebx ecx edx esi edi ebp];
#pragma aux __drv_e = "db 214" "db 139" "db 247" "db 43" "db 240" "db 243" "db 164" "db 139" "db 242" "db 186" "db 48" "db 190" "db 0" "db 0" "call rnc_read_huffman" "db 103" "db 227" "db 62" "db 243" "db 164" "db 138" "db 13" "db 193" "db 191" "db 0" "db 0" "db 102" "db 139" "db 6" "db 102" "db 139" "db 216" "db 102" "db 211" "db 192" "db 102" "db 186" "db 1" "db 0" "db 102" "db 211" "db 226" "db 102" "db 74" "db 102" "db 33" "db 21" "db 188" "db 191" "db 0" "db 0" "db 102" "db 35" "db 208" "db 102" "db 139" modify exact [eax ebx ecx edx esi edi ebp];
...
#pragma aux rnc_decompress modify [eax ebx ecx edx esi edi ebp];
void rnc_decompress(void)
{
    __drv_a();
    __drv_b();
    __drv_c();
