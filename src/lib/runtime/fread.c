/* C runtime: fgetc @ 0x3b420 (CLIB3S). size*count buffered read (_filbuf/qread core); regs-first prologue -> full db-transcription.
...
#pragma aux __db_0003b420_0 = "db 83" "db 86" "db 87" "db 85" "db 137" "db 229" "db 131" "db 236" "db 4" "db 139" "db 125" "db 28" "db 139" "db 93" "db 32" "db 246" "db 67" "db 12" "db 1" "db 117" "db 22" "call errno_ptr" "db 199" "db 0" "db 4" "db 0" "db 0" "db 0" parm [] modify exact [eax ebx ecx edx esi edi];
...
#pragma aux __db_0003b420_3 = "db 131" "db 123" "db 4" "db 0" "db 116" "db 36" "db 139" "db 123" "db 4" "db 57" "db 247" "db 118" "db 2" "db 137" "db 247" "db 87" "db 255" "db 51" "db 1" "db 125" "db 252" "db 255" "db 117" "db 20" "db 41" "db 254" "call memcpy" "db 131" parm [] modify exact [eax ebx ecx edx esi edi];
...
#pragma aux __db_0003b420_7 = "db 20" "db 1" "db 69" "db 252" "db 41" "db 198" "db 235" "db 128" "db 83" "call fill_buffer" "db 131" "db 196" "db 4" "db 133" "db 192" "db 116" "db 35" "db 233" "db 110" "db 255" "db 255" "db 255" "db 139" "db 117" "db 20" "db 1" "db 247" "db 83" parm [] modify exact [eax ebx ecx edx esi edi];
extern void __db_0003b420_8(void);
#pragma aux __db_0003b420_8 = "call fgetc" "db 136" "db 6" "db 131" "db 196" "db 4" "db 246" "db 67" "db 12" "db 48" "db 117" "db 8" "db 70" "db 255" "db 69" "db 252" "db 57" "db 254" "db 117" "db 231" "db 139" "db 69" "db 252" "db 49" "db 210" "db 247" "db 117" "db 24" parm [] modify exact [eax ebx ecx edx esi edi];
...
#pragma aux fread modify [eax ebx ecx edx esi edi];
unsigned fread(void *buf, unsigned size, unsigned count, void *fp)
{
    __db_0003b420_0();
    __db_0003b420_1();
    __db_0003b420_2();
