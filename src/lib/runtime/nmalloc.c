...
extern int heap_grow(unsigned);
extern int clib_ret_zero(unsigned);
...
#pragma aux __mal95_2 = "db 140" "db 218" "db 187" "db 204" "db 191" "db 0" "db 0" "db 15" "db 183" "db 210" "db 137" "db 240" "call heap_alloc" "db 137" "db 195" "db 133" "db 192" "db 117" "db 40" "db 128" "db 125" "db 252" "db 0" "db 117" "db 13" "db 86" "call heap_grow" "db 131" "db 196" "db 4" "db 133" "db 192" "db 117" parm [] modify exact [eax ebx ecx edx esi];
extern void __mal95_3(void);
#pragma aux __mal95_3 = "db 15" "db 86" "call clib_ret_zero" "db 131" "db 196" "db 4" "db 133" "db 192" "db 116" "db 8" "db 235" "db 190" "db 198" "db 69" "db 252" "db 1" "db 235" "db 188" "db 198" "db 5" "db 72" "db 30" "db 1" "db 0" "db 0" "db 137" "db 216" "db 201" "db 15" "db 169" "db 15" "db 161" "db 7" parm [] modify exact [eax ebx ecx edx esi];
extern long __mal95_4(void);
#pragma aux __mal95_4 = "db 94" "db 91" parm [] value [eax] modify exact [eax ebx ecx edx esi];
#pragma aux nmalloc modify [eax ebx ecx edx esi];
void *nmalloc(unsigned size)
{
    __mal95_1();
    __mal95_2();
    __mal95_3();
