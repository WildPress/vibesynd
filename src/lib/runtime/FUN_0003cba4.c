...
#pragma aux __FUN_0003cba4_0 = "db 83" "db 86" "db 87" "db 85" "db 137" "db 229" "db 139" "db 53" "db 244" "db 194" "db 0" "db 0" "db 133" "db 246" "db 116" "db 62" "db 131" "db 125" "db 20" "db 0" "db 116" "db 56" "db 255" "db 117" "db 20" "call FUN_0003dc1b" "db 131" "db 196" "db 4" "db 137" "db 199" "db 235" "db 35" "db 87" "db 255" "db 117" "db 20" "db 83" "call strnicmp" "db 131" "db 196" "db 12" "db 133" "db 192" "db 117" "db 15" "db 141" "db 4" "db 59" "db 128" "db 56" "db 61" "db 117" "db 7" "db 141" "db 71" "db 1" "db 1" "db 216" "db 235" "db 11" "db 131" "db 198" "db 4" modify exact [eax ebx ecx edx esi edi ebp];
