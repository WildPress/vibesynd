/* C runtime: fgets/getline @ 0x3b326 (CLIB3S, Watcom 9.5). Reads a line from the
   ...
   characters: __fgetc-style inline getc from the g_c080 buffer, or __filbuf refill
...
#pragma aux __fgets1 = "db 83" "db 86" "db 87" "db 85" "db 137" "db 229" "db 139" "db 117" "db 20" "db 139" "db 61" "db 140" "db 192" "db 0" "db 0" "db 137" "db 243" "db 128" "db 37" "db 140" "db 192" "db 0" "db 0" "db 207" "db 131" "db 231" "db 48" "db 246" "db 5" "db 140" "db 192" "db 0" "db 0" "db 64" "db 116" "db 43" "db 255" "db 13" "db 132" "db 192" "db 0" "db 0" "db 131" "db 61" "db 132" "db 192" "db 0" "db 0" "db 0" "db 125" "db 12" "db 104" "db 128" "db 192" "db 0" "db 0" "call __filbuf" "db 235" "db 26" "db 161" "db 128" "db 192" "db 0" "db 0" "db 255" "db 5" "db 128" "db 192" "db 0" "db 0" parm [] modify exact [eax ecx edx];
