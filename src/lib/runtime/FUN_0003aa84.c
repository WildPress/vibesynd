...
#pragma aux __mal95_2 = "db 140" "db 218" "db 187" "db 204" "db 191" "db 0" "db 0" "db 15" "db 183" "db 210" "db 137" "db 240" "call heap_alloc" "db 137" "db 195" "db 133" "db 192" "db 117" "db 40" "db 128" "db 125" "db 252" "db 0" "db 117" "db 13" "db 86" "call FUN_0003c816" "db 131" "db 196" "db 4" "db 133" "db 192" "db 117" parm [] modify exact [eax ebx ecx edx esi];
