/* C runtime: system @ 0x3af38 (CLIB3S, Watcom 9.5). Runs a command through the shell.
   ...
   argument via spawnve; then spawns it with FUN_0003cfce, choosing the "/c" (0x3d4c)
...
#pragma aux __system2 = "db 106" "db 0" "db 255" "db 117" "db 12" "db 15" "db 182" "db 69" "db 252" "db 80" "db 141" "db 69" "db 248" "db 80" "call spawnve" "db 131" "db 196" "db 8" "db 80" "db 128" "db 125" "db 252" "db 0" "db 116" "db 7" "db 184" "db 76" "db 61" "db 0" "db 0" "db 235" "db 5" "db 184" "db 80" "db 61" "db 0" "db 0" "db 80" "db 83" "db 106" "db 0" "call FUN_0003cfce" "db 131" "db 196" "db 24" "db 201" "db 91" parm [] value [eax] modify exact [eax ecx edx];
