...
#pragma aux __rd95_1 = "db 83" "db 86" "db 87" "db 85" "db 137" "db 229" "db 131" "db 236" "db 16" "db 139" "db 125" "db 24" "db 139" "db 117" "db 28" "db 255" "db 117" "db 20" "call fd_to_stream" "db 131" "db 196" "db 4" "db 137" "db 69" "db 244" "db 133" "db 192" "db 117" "db 21" "call errno_ptr" "db 199" "db 0" "db 4" parm [] modify exact [eax ebx ecx edx esi edi];
extern void __rd95_2(void);
#pragma aux __rd95_2 = "db 0" "db 0" "db 0" "db 184" "db 255" "db 255" "db 255" "db 255" "db 233" "db 158" "db 0" "db 0" "db 0" "db 168" "db 1" "db 117" "db 13" "call errno_ptr" "db 199" "db 0" "db 6" "db 0" "db 0" "db 0" "db 235" "db 229" "db 168" "db 64" "db 116" "db 45" "db 102" "db 139" "db 93" parm [] modify exact [eax ebx ecx edx esi edi];
extern void __rd95_3(void);
#pragma aux __rd95_3 = "db 20" "db 137" "db 250" "db 137" "db 241" "db 180" "db 63" "db 205" "db 33" "db 209" "db 208" "db 209" "db 200" "db 137" "db 69" "db 240" "db 137" "db 69" "db 248" "db 133" "db 192" "db 15" "db 141" "db 104" "db 0" "db 0" "db 0" "db 15" "db 183" "db 69" "db 240" "db 80" "call set_doserr" parm [] modify exact [eax ebx ecx edx esi edi];
...
#pragma aux read modify [eax ebx ecx edx esi edi];
long read(int handle, void *buf, unsigned len)
{
    __rd95_1();
    __rd95_2();
    __rd95_3();
