...
#pragma aux __c019_5 = "db 142" "db 69" "db 252" "db 38" "db 198" "db 7" "db 0" "db 106" "db 255" "db 15" "db 183" "db 69" "db 252" "db 80" "db 87" "call FUN_0003be93" "db 131" "db 196" "db 12" "db 233" "db 182" "db 1" "db 0" "db 0" "db 246" "db 67" "db 20" "db 32" "db 116" "db 20" "db 131" "db 0" "db 4" "db 255" "db 117" "db 244" "db 139" "db 0" "db 86" "db 139" "db 64" "db 252" "db 80" "call ltoa" "db 235" "db 188" "db 246" "db 67" "db 20" "db 16" "db 116" "db 15" "db 131" "db 0" "db 4" "db 255" "db 117" "db 244" "db 139" "db 0" "db 86" "db 15" "db 191" "db 64" "db 252" "db 235" "db 227" "db 255" "db 117" "db 244" "db 131" "db 0" "db 4" "db 86" "db 139" "db 0" "db 255" "db 112" "db 252" modify exact [eax ebx ecx edx esi edi ebp];
...
#pragma aux __c019_9 = "db 255" "db 0" "db 0" "db 80" "call FUN_0003bee3" "db 131" "db 196" "db 12" "db 106" "db 8" "db 141" "db 70" "db 5" "db 80" "db 255" "db 117" "db 236" "db 198" "db 70" "db 4" "db 58" "db 235" "db 4" "db 106" "db 8" "db 86" "db 82" "call FUN_0003bee3" "db 131" "db 196" "db 12" "db 128" "db 123" "db 21" "db 80" "db 15" "db 133" "db 119" "db 254" "db 255" "db 255" "db 86" "call strupr" "db 131" "db 196" "db 4" "db 233" "db 105" "db 254" "db 255" "db 255" "db 131" "db 0" "db 4" "db 139" "db 0" "db 138" "db 64" "db 252" "db 136" "db 6" "db 49" "db 192" "db 136" "db 70" "db 1" "db 137" "db 69" "db 248" "db 235" "db 16" "db 49" "db 210" "db 137" "db 83" "db 4" modify exact [eax ebx ecx edx esi edi ebp];
