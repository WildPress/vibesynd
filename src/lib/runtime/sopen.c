...
extern void fd_handle_store(int, int);
...
#pragma aux __op95_3 = "db 246" "db 69" "db 24" "db 3" "db 15" "db 132" "db 106" "db 0" "db 0" "db 0" "db 131" "db 125" "db 248" "db 255" "db 116" "db 100" "db 255" "db 117" "db 248" "call isatty" "db 131" "db 196" "db 4" "db 133" "db 192" "db 117" "db 85" "db 246" "db 69" "db 25" "db 4" "db 116" "db 33" parm [] modify exact [eax ebx ecx edx esi edi];
extern void __op95_4(void);
#pragma aux __op95_4 = "db 102" "db 139" "db 93" "db 248" "db 180" "db 62" "db 205" "db 33" "db 209" "db 208" "db 209" "db 200" "call errno_ptr" "db 199" "db 0" "db 7" "db 0" "db 0" "db 0" "db 184" "db 255" "db 255" "db 255" "db 255" "db 233" "db 51" "db 1" "db 0" "db 0" "db 246" "db 69" "db 24" "db 64" parm [] modify exact [eax ebx ecx edx esi edi];
...
#pragma aux __op95_8 = "db 137" "db 242" "db 15" "db 182" "db 201" "db 180" "db 60" "db 205" "db 33" "db 209" "db 208" "db 209" "db 200" "db 137" "db 199" "db 133" "db 192" "db 125" "db 17" "db 15" "db 183" "db 192" "db 80" "call set_doserr" "db 131" "db 196" "db 4" "db 233" "db 168" "db 0" "db 0" "db 0" "db 15" parm [] modify exact [eax ebx ecx edx esi edi];
...
#pragma aux __op95_10 = "db 209" "db 200" "db 137" "db 199" "db 133" "db 192" "db 124" "db 197" "db 15" "db 183" "db 192" "db 137" "db 69" "db 248" "db 255" "db 117" "db 248" "call fd_to_stream" "db 131" "db 196" "db 4" "db 36" "db 60" "db 255" "db 117" "db 248" "db 137" "db 195" "call isatty" "db 131" "db 196" "db 4" "db 133" parm [] modify exact [eax ebx ecx edx esi edi];
...
#pragma aux __op95_13 = "db 137" "db 194" "db 0" "db 0" "db 0" "db 2" "db 0" "db 0" "db 117" "db 2" "db 137" "db 195" "db 83" "db 255" "db 117" "db 248" "call fd_handle_store" "db 139" "db 69" "db 248" "db 131" "db 196" "db 8" "db 201" "db 95" "db 94" "db 91" parm [] value [eax] modify exact [eax ebx ecx edx esi edi];
#pragma aux sopen modify [eax ebx ecx edx esi edi];
long sopen(char *name, int oflag, int pmode, int shflag)
{
    __op95_1();
    __op95_2();
    __op95_3();
