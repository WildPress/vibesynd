/* C runtime: stream mode/reopen helper @ 0x3cb24 (CLIB3S, Watcom 9.5). Framed
   ...
   is 0, toggles the +0xd binary/text flag, then calls the core doprnt with a
   literal format ptr (0x2f3c2) plus the two extra args, optionally re-syncs via
   flush_stream, folds a -1 error when the 0x20 flag is set, and restores the saved
...
extern void doprnt(void);
extern void flush_stream(void);
...
#pragma aux __FUN_0003cb24_1 = "db 117" "db 24" "db 83" "call doprnt" "db 137" "db 198" "db 131" "db 196" "db 16" "db 133" "db 255" "db 116" "db 17" "db 128" "db 99" "db 13" "db 254" "db 83" "db 128" "db 75" "db 13" "db 4" "call flush_stream" "db 131" "db 196" "db 4" "db 246" "db 67" "db 12" "db 32" "db 116" "db 5" "db 190" "db 255" "db 255" "db 255" "db 255" "db 139" "db 125" "db 252" "db 137" "db 240" "db 9" "db 123" "db 12" "db 201" "db 95" "db 94" "db 91" modify exact [eax ebx ecx edx esi edi ebp];
#pragma aux stream_reopen modify [eax ebx ecx edx esi edi ebp];
void stream_reopen(void)
{
    __FUN_0003cb24_0();
    __FUN_0003cb24_1();
}
