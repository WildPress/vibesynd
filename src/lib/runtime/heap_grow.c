/* C runtime: heap-grow / sbrk-style allocator core @ 0x3c816 (CLIB3S, Watcom 9.5).
   ...
   via the DOS allocate call (INT 21h AX=0x4800) or the helper dpmi_dos_alloc_paras, links the
   new block into the free list at g_bfc4/g_bfc8, updates the high-water marks
   g_bfd4/g_bfd8 and the arena tail (g_bfdc/g_bfe0), and calls nfree to register
...
extern void dpmi_dos_alloc_paras(void);
