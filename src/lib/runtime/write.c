...
extern int fd_to_stream(int);
extern int *errno_ptr(void);
extern void set_doserr(int);
extern unsigned stack_avail(void);
extern void stack_overflow(void);
extern void __wr95_1(void);
#pragma aux __wr95_1 = "db 83" "db 86" "db 87" "db 85" "db 137" "db 229" "db 131" "db 236" "db 24" "db 255" "db 117" "db 20" "call fd_to_stream" "db 131" "db 196" "db 4" "db 137" "db 69" "db 236" "db 133" "db 192" "db 117" "db 21" "call errno_ptr" "db 199" "db 0" "db 4" "db 0" "db 0" "db 0" "db 184" "db 255" "db 255" parm [] modify exact [eax ebx ecx edx esi edi];
extern void __wr95_2(void);
#pragma aux __wr95_2 = "db 255" "db 255" "db 233" "db 163" "db 1" "db 0" "db 0" "db 168" "db 2" "db 117" "db 13" "call errno_ptr" "db 199" "db 0" "db 6" "db 0" "db 0" "db 0" "db 235" "db 229" "db 168" "db 128" "db 116" "db 54" "db 102" "db 139" "db 93" "db 20" "db 176" "db 2" "db 49" "db 210" "db 180" parm [] modify exact [eax ebx ecx edx esi edi];
extern void __wr95_3(void);
#pragma aux __wr95_3 = "db 66" "db 139" "db 202" "db 193" "db 233" "db 16" "db 205" "db 33" "db 102" "db 209" "db 210" "db 102" "db 209" "db 202" "db 193" "db 226" "db 16" "db 102" "db 139" "db 208" "db 137" "db 85" "db 232" "db 133" "db 210" "db 125" "db 18" "db 15" "db 183" "db 69" "db 232" "db 80" "call set_doserr" parm [] modify exact [eax ebx ecx edx esi edi];
...
#pragma aux __wr95_5 = "db 198" "db 137" "db 69" "db 232" "db 133" "db 192" "db 124" "db 205" "db 59" "db 69" "db 28" "db 15" "db 132" "db 43" "db 1" "db 0" "db 0" "call errno_ptr" "db 137" "db 117" "db 28" "db 199" "db 0" "db 12" "db 0" "db 0" "db 0" "db 233" "db 24" "db 1" "db 0" "db 0" "call stack_avail" parm [] modify exact [eax ebx ecx edx esi edi];
extern void __wr95_6(void);
#pragma aux __wr95_6 = "db 137" "db 195" "db 61" "db 176" "db 0" "db 0" "db 0" "db 115" "db 5" "call stack_overflow" "db 191" "db 0" "db 2" "db 0" "db 0" "db 129" "db 251" "db 48" "db 2" "db 0" "db 0" "db 115" "db 5" "db 191" "db 128" "db 0" "db 0" "db 0" "db 137" "db 248" "db 41" "db 196" "db 137" parm [] modify exact [eax ebx ecx edx esi edi];
...
#pragma aux __wr95_9 = "db 209" "db 200" "db 137" "db 198" "db 137" "db 69" "db 232" "db 133" "db 192" "db 15" "db 140" "db 54" "db 255" "db 255" "db 255" "db 57" "db 248" "db 116" "db 21" "call errno_ptr" "db 199" "db 0" "db 12" "db 0" "db 0" "db 0" "db 139" "db 69" "db 248" "db 1" "db 240" "db 233" "db 135" parm [] modify exact [eax ebx ecx edx esi edi];
...
#pragma aux __wr95_13 = "db 200" "db 137" "db 199" "db 137" "db 69" "db 232" "db 133" "db 192" "db 15" "db 140" "db 175" "db 254" "db 255" "db 255" "db 57" "db 240" "db 116" "db 18" "call errno_ptr" "db 199" "db 0" "db 12" "db 0" "db 0" "db 0" "db 139" "db 69" "db 248" "db 1" "db 248" "db 235" "db 3" "db 139" parm [] modify exact [eax ebx ecx edx esi edi];
...
#pragma aux write modify [eax ebx ecx edx esi edi];
long write(int handle, void *buf, unsigned len)
{
    __wr95_1();
    __wr95_2();
    __wr95_3();
