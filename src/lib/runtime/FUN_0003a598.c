...
#pragma aux __op95_10 = "db 209" "db 200" "db 137" "db 199" "db 133" "db 192" "db 124" "db 197" "db 15" "db 183" "db 192" "db 137" "db 69" "db 248" "db 255" "db 117" "db 248" "call FUN_0003c529" "db 131" "db 196" "db 4" "db 36" "db 60" "db 255" "db 117" "db 248" "db 137" "db 195" "call isatty" "db 131" "db 196" "db 4" "db 133" parm [] modify exact [eax ebx ecx edx esi edi];
