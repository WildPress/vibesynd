/* C runtime helper @ 0x3b2b5 (CLIB3S region, buffered console output). Writes the
   character c to the console stream (FILE at 0xc09a) via the fast putc FUN_0003d24a;
   ...
   otherwise it calls the slow putc FUN_0003d2c3(0x0A, stream). Returns 0 when the
...
extern void FUN_0003d24a(void);
extern void FUN_0003d2c3(void);
extern void __putln1(void);
extern int  __putln2(void);
#pragma aux __putln1 = "db 85" "db 137" "db 229" "db 104" "db 154" "db 192" "db 0" "db 0" "db 255" "db 117" "db 8" "call FUN_0003d24a" "db 131" "db 196" "db 8" "db 137" "db 194" "db 131" "db 248" "db 255" "db 116" "db 83" "db 246" "db 5" "db 166" "db 192" "db 0" "db 0" "db 64" "db 116" "db 50" "db 161" "db 174" "db 192" "db 0" "db 0" "db 43" "db 5" "db 158" "db 192" "db 0" "db 0" "db 131" "db 248" "db 1" "db 118" "db 34" "db 128" "db 13" "db 167" "db 192" "db 0" "db 0" "db 16" parm [] modify exact [eax ecx edx];
#pragma aux __putln2 = "db 255" "db 5" "db 158" "db 192" "db 0" "db 0" "db 161" "db 154" "db 192" "db 0" "db 0" "db 255" "db 5" "db 154" "db 192" "db 0" "db 0" "db 198" "db 0" "db 10" "db 184" "db 10" "db 0" "db 0" "db 0" "db 235" "db 15" "db 104" "db 154" "db 192" "db 0" "db 0" "db 106" "db 10" "call FUN_0003d2c3" "db 131" "db 196" "db 8" "db 137" "db 194" "db 131" "db 248" "db 10" "db 117" "db 2" "db 49" "db 210" "db 137" "db 208" "db 93" parm [] value [eax] modify exact [eax ecx edx];
int FUN_0003b2b5(int c)
{
    __putln1();
    return __putln2();
}
