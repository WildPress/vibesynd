...
extern void FUN_0003d935();
extern void FUN_0003d40f();
extern void FUN_0003b539();
...
#pragma aux __db_0003b420_2 = "db 8" "db 0" "db 117" "db 9" "db 83" "call FUN_0003d894" "db 131" "db 196" "db 4" "db 199" "db 69" "db 252" "db 0" "db 0" "db 0" "db 0" "db 246" "db 67" "db 12" "db 64" "db 15" "db 132" "db 148" "db 0" "db 0" "db 0" "db 137" "db 254" parm [] modify exact [eax ebx ecx edx esi edi];
...
#pragma aux __db_0003b420_6 = "db 16" "call FUN_0003d935" "db 131" "db 196" "db 12" "db 131" "db 248" "db 255" "db 117" "db 6" "db 128" "db 75" "db 12" "db 32" "db 235" "db 68" "db 133" "db 192" "db 117" "db 6" "db 128" "db 75" "db 12" "db 16" "db 235" "db 58" "db 1" "db 69" parm [] modify exact [eax ebx ecx edx esi edi];
...
#pragma aux __db_0003b420_8 = "call FUN_0003b539" "db 136" "db 6" "db 131" "db 196" "db 4" "db 246" "db 67" "db 12" "db 48" "db 117" "db 8" "db 70" "db 255" "db 69" "db 252" "db 57" "db 254" "db 117" "db 231" "db 139" "db 69" "db 252" "db 49" "db 210" "db 247" "db 117" "db 24" parm [] modify exact [eax ebx ecx edx esi edi];
