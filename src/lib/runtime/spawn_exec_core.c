...
#pragma aux spawn_exec_core modify [eax ebx ecx edx esi edi ebp];
void spawn_exec_core(void)
{
    __FUN_0003cc74_0();
    __FUN_0003cc74_1();
    __FUN_0003cc74_2();
