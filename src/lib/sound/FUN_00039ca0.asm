; FUN_00039ca0 @ 0x39ca0  (418 bytes) -- hand-written assembly (fully commented).
;
; FUN_00039ca0: play an Autodesk FLIC/FLC animation. Despite living in the sound module,
...
; Calls: FUN_0003a598 (open file), FUN_0003a7c4 (read bytes), FUN_00039ee2 (parse FLC
;   header), FUN_000391a8 (per-frame callback), FUN_00039e42 (decode frame), FUN_00039f92
...
read_chunk:
        ...
        jne     chk_frame
        call    0x39ee2                      ; -> FUN_00039ee2: parse header (frames, w, h)
...
chk_frame:
        ...
        add     esp, 4
        call    0x39e42                      ; -> FUN_00039e42: decode this frame's sub-chunks
        ...
        call    0x39f92                      ; -> FUN_00039f92: apply new palette
blit_frame:
        push    ecx
        push    edi
        push    esi
