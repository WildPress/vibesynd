; FUN_00039f92 @ 0x39f92  (161 bytes) -- hand-written assembly (fully commented).
;
; FUN_00039f92: rebuild the 256-colour VGA palette from a run-length palette script and
; blast it to the DAC during vertical retrace. Part of the FLIC player (FUN_00039ca0);
