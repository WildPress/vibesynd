; FUN_000397f1 @ 000397f1  (85 bytes) -- hand-written assembly (fully commented).
;
; FUN_000397f1: set a sequence's tick period (in microseconds) and re-derive the shared
