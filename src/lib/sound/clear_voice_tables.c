/* clear_voice_tables -- SKIP-ASM-IDIOM (clear voice tables, 77B).
...
#pragma aux clear_voice_tables modify [eax ebx ecx edx esi edi ebp];
void clear_voice_tables(void) { __b000393931(); __b000393932(); }
