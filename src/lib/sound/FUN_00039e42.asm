; FUN_00039e42 @ 0x39e42  (160 bytes) -- hand-written assembly (fully commented).
;
; FUN_00039e42: decode one FLIC/FLC frame by walking its sub-chunks. A FLIC frame chunk
; (magic 0xF1FA, handled by FUN_00039ca0) contains a count of sub-chunks followed by
