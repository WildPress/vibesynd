; run_seq_commands @ 000391a8  (216 bytes) -- hand-written assembly (fully commented).
;
; run_seq_commands: walk a table of 4-byte command records and execute each one, for as
...
;   'S'/'s' : if g_sound_enabled (0x10b4a) is set, call play_sound_slot(param)
...
; Calls:    0x35f78 play_sound_slot ('S')         0x38fe8 sound_channel_select ('m')
;
run_seq_commands:
...
; .cmd_S (0x39206): 'S'/'s' -- gated sound command
        ...
        call    0x35f78                          ; e848cdffff     -> play_sound_slot(param)
