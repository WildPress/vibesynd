/* init_voice_tables -- SKIP-ASM-IDIOM (init voice tables, 106B).
...
#pragma aux init_voice_tables modify [eax ebx ecx edx esi edi ebp];
void init_voice_tables(void) { __b0003954c1(); __b0003954c2(); }
