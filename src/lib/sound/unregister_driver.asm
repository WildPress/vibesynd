; unregister_driver @ 00039966  (46 bytes) -- hand-written assembly (fully commented).
;
; unregister_driver: unregister a driver slot -- clear g_driver_ptr[slot] back to 0, freeing
; the entry that register_driver filled in. The slot index is bounds-checked (must be < 16);
