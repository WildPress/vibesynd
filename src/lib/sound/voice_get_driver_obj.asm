; voice_get_driver_obj @ 0x39994  (31 bytes) -- hand-written assembly (fully commented).
;
; voice_get_driver_obj: a thin wrapper that invokes driver command 0x64 on a voice, passing a
...
; returned eax is used by start_voice as a pointer whose field [+0x20] it reads.
