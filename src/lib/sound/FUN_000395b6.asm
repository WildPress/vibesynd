; FUN_000395b6 @ 000395b6  (111 bytes) -- hand-written assembly (fully commented).
;
; FUN_000395b6: driver teardown -- walk all 16 driver slots and, for every registered
...
; .loop (0x395c7):
        ...
        call    0x396d5                           ; e8e9000000   -> FUN_000396d5(handle): stop seq
        add     esp, 4                            ; 83c404
...
; .next (0x39600):
        ...
        call    0x39722                           ; e80e010000   -> FUN_00039722(): stop all seqs
