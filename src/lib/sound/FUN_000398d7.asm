; FUN_000398d7 @ 000398d7  (143 bytes) -- hand-written assembly (fully commented).
;
; FUN_000398d7: register a driver/timbre record into a free driver slot. Find the first
...
; driver with dispatch message 0x64 (via FUN_00039994) and sanity-check what it returns.
...
;           0xbdbe loop counter
; Calls:    0x39994 FUN_00039994(slot) -- dispatch message 0x64 to the newly registered driver
;
FUN_000398d7:
        push    ebp                              ; 55
        mov     ebp, esp                          ; 8bec
...
; .register (0x39913): esi = slot*4, validate and install the record
        ...
        call    0x39994                            ; e85d000000  -> FUN_00039994(i): dispatch msg 0x64
        add     esp, 4                             ; 83c404
