; FUN_00039495 @ 00039495  (49 bytes) -- hand-written assembly (fully commented).
;
; FUN_00039495: convert a period in microseconds to an 8253/8254 PIT channel-0 reload
