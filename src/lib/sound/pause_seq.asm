; pause_seq @ 0003979c  (48 bytes) -- hand-written assembly (fully commented).
;
; pause_seq: pause a sequence. If the slot's state word is 2 (running), drop it back
; to 1 (loaded/paused); otherwise leave it untouched. This is the exact inverse of
; start_seq (1->2, start/resume): the timer ISR stops servicing a slot once it is
