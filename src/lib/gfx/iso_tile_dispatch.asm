; iso_tile_dispatch @ 0004107b  (95 bytes) -- hand-written assembly (fully commented).
;
...
; draw_tile_region once per strip.
;
...
; The build uses iso_tile_dispatch.c (a db-transcription of the raw bytes); this .asm is
