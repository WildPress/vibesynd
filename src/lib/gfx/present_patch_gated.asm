; present_patch_gated @ 0x49edf  (989 bytes) -- hand-written assembly (fully commented).
;
; present_patch_gated: present a 16-column x 16-row region of the offscreen buffer to VGA,
