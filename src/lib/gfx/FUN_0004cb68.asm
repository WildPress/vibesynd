; FUN_0004cb68 @ 0004cb68  (227 bytes) -- hand-written assembly (fully commented).
;
...
; wrappers FUN_0004cacc (hex) and FUN_0004cb1a (decimal).
; The build uses FUN_0004cb68.c (db-transcription); this is the readable companion.
;
FUN_0004cb68:
        push    ebp                              ; 55
        mov     ebp, esp                         ; 8bec
