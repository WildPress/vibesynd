; iso_block_dispatch @ 00045e61  (151 bytes) -- hand-written assembly (fully commented).
;
; Same tile-address-and-triangle dispatch as iso_tile_dispatch, but for a 2-unit tile grid
...
;
; Coordinate maths (note the /2 and &1 in place of iso_tile_dispatch's /256 and &255, so a
...
;
; The build uses iso_block_dispatch.c (a db-transcription of the raw bytes); this .asm is
