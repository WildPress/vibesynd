; upload_palette @ 0x4987e  (113 bytes) -- hand-written assembly (fully commented).
;
; upload_palette: upload a palette to the VGA DAC. The size depends on the render mode:
