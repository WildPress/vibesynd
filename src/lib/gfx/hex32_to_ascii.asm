; hex32_to_ascii @ 0004d513  (25 bytes) -- hand-written assembly (fully commented).
;
...
; suppression and no terminator (the caller null-terminates, e.g. draw_hex).
...
; The build uses hex32_to_ascii.c (db-transcription); this listing is the readable
