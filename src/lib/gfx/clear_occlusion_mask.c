...
#pragma aux clear_occlusion_mask modify [eax ebx ecx edx esi edi ebp];
void clear_occlusion_mask(void) { __db_FUN_00046188_0(); __db_FUN_00046188_1(); __db_FUN_00046188_2(); }
