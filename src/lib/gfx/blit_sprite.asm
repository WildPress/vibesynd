; blit_sprite @ 0x4a69c  (44 bytes) -- hand-written assembly (fully commented).
;
; blit_sprite: fully-parameterised planar blit. Same worker as draw_sprite_buf/66b
; (span_op_dispatch) but every input is passed explicitly on the stack rather than pulled
