; FUN_000418ac @ 000418ac  (408 bytes) -- hand-written assembly (fully commented).
;
...
; is a 32-bit accumulated mask (FUN_00046188 zeroes them at the start of a pass).
;
...
;
; Called from the scene walkers (FUN_00041a44 / FUN_000436b2 / FUN_0004483d), once
; per drawable cell. The build uses FUN_000418ac.c (a db-transcription of the raw
