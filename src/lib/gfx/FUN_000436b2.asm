; FUN_000436b2 @ 000436b2  (4491 bytes) -- hand-written assembly (fully commented).
;
; FUN_000436b2: the same isometric scene visibility walker as FUN_00041a44, walking the
...
;
; The build uses FUN_000436b2.c (a db-transcription of the raw bytes); this .asm is the
