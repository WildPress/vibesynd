; FUN_0004cc4d @ 0004cc4d  (42 bytes) -- hand-written assembly (fully commented).
;
...
;   bit 1 -> planar 16-colour offscreen buffer: call glyph_blit_wide (FUN_0004cc77)
...
;
; Globals/ports: 0x105 render-mode flags. The build uses FUN_0004cc4d.c
...
FUN_0004cc4d:
        ...
        call    0x4cc77                          ; e81c000000  -- FUN_0004cc77: draw wide glyph (planar)
