; FUN_0004d352 @ 0004d352  (65 bytes) -- hand-written assembly (fully commented).
;
; isqrt16: integer square root of a 16-bit unsigned value. Identical method to the
; 32-bit FUN_0004d393 but working in 16-bit registers: bsr to find the magnitude,
...
; The build uses FUN_0004d352.c (db-transcription); this is the readable companion.
;
FUN_0004d352:
        push    ebp                              ; 55
        mov     ebp, esp                         ; 8bec
