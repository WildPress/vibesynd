; glyph_blit_narrow @ 0004cd3e  (164 bytes) -- hand-written assembly (fully commented).
;
; glyph_blit_narrow: the up-to-8-pixel-wide sibling of glyph_blit_wide (glyph_blit_wide).
...
; Globals: 0x5368 g_screen_buf (plane 0 base). The build uses glyph_blit_narrow.c
