; FUN_0004cacc @ 0004cacc  (78 bytes) -- hand-written assembly (fully commented).
;
...
; (via FUN_0004d513), then points at the right-justified tail of that buffer -- the
; last `ndigits` characters -- and hands it, with the caller's font/x/y/colour, to the
; proportional text renderer FUN_0004cb68.
;
...
; Globals: 0xe384 scratch text buffer. The build uses FUN_0004cacc.c
...
FUN_0004cacc:
        ...
        call    0x4d513                          ; e8320a0000  -- FUN_0004d513: write 8 hex digits (edi += 8)
        ...
        call    0x4cb68                          ; e858000000  -- FUN_0004cb68: draw the text
