; restore_backing_column @ 0x4a3cc  (99 bytes) -- hand-written assembly (fully commented).
;
; restore_backing_column: restore a 16-pixel-wide, 17-row column into g_screen_buf from a fixed
; scratch save area at 0x3cb74. This is the "restore" half of a backing-store pair;
; save_backing_column is the matching "save" that copies the same column the other way.
;
