; present_frame_planar @ 0x4a5a8  (145 bytes) -- hand-written assembly (fully commented).
;
; present_frame_planar: present the whole offscreen frame to VGA using string moves. This is
; the planar-present implementation called by the dispatcher present_frame_dispatch.
;
