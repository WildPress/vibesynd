; plot_op_dispatch @ 000402e0  (7 bytes) -- hand-written assembly (fully commented).
;
...
; jumps straight into the selected handler, which returns to plot_op_dispatch's caller.
;
...
;
; The build uses plot_op_dispatch.c (the raw bytes as a db-transcription); this .asm is
