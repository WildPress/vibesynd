; iso_block_dispatch2 @ 00045f8a  (151 bytes) -- hand-written assembly (fully commented).
;
; The twin of iso_block_dispatch: the same 2-unit tile-address-and-triangle dispatch, with
...
;
; The build uses iso_block_dispatch2.c (a db-transcription of the raw bytes); this .asm is
