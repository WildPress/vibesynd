; draw_animated_marker @ 0x49b67  (886 bytes) -- hand-written assembly (fully commented).
;
; draw_animated_marker: copy one animated 16x16-pixel cell from the back buffer to the screen
