...
#pragma aux iso_cell_dispatch modify [eax ebx ecx edx esi edi ebp] aborts;
void iso_cell_dispatch(void) { __db_FUN_00047a7e_0(); __db_FUN_00047a7e_1(); __db_FUN_00047a7e_2(); }
