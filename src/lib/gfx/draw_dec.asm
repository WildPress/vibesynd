; draw_dec @ 0004cb1a  (78 bytes) -- hand-written assembly (fully commented).
;
; draw_dec: the decimal twin of draw_hex (draw_hex). It formats a 32-bit value as
; a 10-digit decimal string in the scratch buffer at 0xe384 (via dec32_to_ascii), then
; draws the right-justified last `ndigits` characters through the proportional text
; renderer draw_text. The string pointer is 0xe384 + 0xa - ndigits, so the leading
...
; Globals: 0xe384 scratch text buffer. The build uses draw_dec.c
...
draw_dec:
        ...
        call    0x4d451                          ; e822090000  -- dec32_to_ascii: write 10 decimal digits (edi += 10)
        ...
        call    0x4cb68                          ; e80a000000  -- draw_text: draw the text
