; FUN_0004d451 @ 0004d451  (39 bytes) -- hand-written assembly (fully commented).
;
...
; FUN_0004cb1a). No terminator is written.
;
...
; (dwords: 1e9, 1e8, ... 10, 1). The build uses FUN_0004d451.c (db-transcription);
