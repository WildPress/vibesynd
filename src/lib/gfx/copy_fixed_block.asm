; copy_fixed_block @ 0004d04b  (30 bytes) -- hand-written assembly (fully commented).
;
...
; Clobbers ecx, esi, edi. The build uses copy_fixed_block.c (db-transcription); this is
