; span_op_dispatch @ 0004b073  (64 bytes) -- hand-written assembly (fully commented).
;
...
; The build uses span_op_dispatch.c (db-transcription); this is the readable companion.
;
span_op_dispatch:
