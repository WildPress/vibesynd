; draw_sprite_surf @ 0x4a66b  (49 bytes) -- hand-written assembly (fully commented).
;
; draw_sprite_surf: draw a sprite from a descriptor into the buffer pointed to by global
; 0x5374. Identical to draw_sprite_buf except for the destination: instead of
...
; +5 = height byte. Register set-up matches the span_op_dispatch convention.
;
; Args (stack / cdecl):
