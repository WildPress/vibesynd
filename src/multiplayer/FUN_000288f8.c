...
/* frameless @ 0x288f8: chunked loop. Sibling of 0x28878. Call
   FUN_00028558(p1,p2,p3,0) for param_4/g_df38 whole chunks (g_df38 is the
...
extern short FUN_00028558(int, unsigned int, unsigned int *, unsigned short);
unsigned int FUN_000288f8(int param_1, unsigned short param_2, unsigned int *param_3, unsigned int param_4)
{
    ...
    for (i = 0; i < param_4 / g_df38; i++) {
        s = FUN_00028558(param_1, param_2, param_3, 0);
        if (s != g_df38)
            goto out;
