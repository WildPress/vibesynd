...
/* Callee is dpmi_free_dos_mem @0x287e8 (original 0x27ef1: `call 0x287e8`); the prior
   FUN_000287c8 symbol was a mis-transcribed target (0x287c8 lands mid-dos_alloc_and_zero). */
extern void dpmi_free_dos_mem(int a, int b);
void guarded_call_2arg(int p1, unsigned short p2)
{
    if (p1 != 0 || p2 != 0)
        dpmi_free_dos_mem(p1, p2);
}
