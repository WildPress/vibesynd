...
unsigned char *FUN_0002e5f8(unsigned char *p1, unsigned char *p2, int dist)
{
    int d1, d2;
    unsigned char *q;
    short x;
    ...
    if (*(p2 + 0x19) == 0x17)
        return 0;
    d1 = FUN_00014c58((short)(*(short *)(p2 + 4) - *(short *)(p1 + 4)),
    ...
    dir1 = FUN_0004d221((short)(*(short *)(p2 + 4) - x),
                        (short)(*(short *)(p2 + 6) - y));
    d2 = FUN_00014c58((short)(*(short *)(p2 + 4) - x),
                      (short)(*(short *)(p2 + 6) - y));
    dir2 = FUN_0004d221((short)(*(short *)(p2 + 8) - z), (short)d2);
    for (; (short)i < (short)dist; i++) {
        if ((short)FUN_0000f898(x, y, (short)(z + 0x80)) != 0)
            return 0;
