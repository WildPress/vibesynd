 ...
 *
 * Validates the current shot-cursor position (g_aim_x, g_aim_y, g_10b2c)
...
{
    if (FUN_0002d468(g_aim_x, g_aim_y, g_10b2c, param_1) != 0) {
        g_10b2c = g_10b2c + g_e128;
        FUN_00026c78(param_1, g_aim_x, g_aim_y, g_10b2c);
        return 0;
    }
    return 1;
}
