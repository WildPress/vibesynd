 ...
 * Measures via 0x36648 (table g_11be4), computes a centred/offset x, then
...
{
    FUN_00036698(a,
                 (unsigned short)(b + (d - FUN_00036648(a, g_11be4, e, f, g)) / 2),
                 (unsigned short)(c + 8), 0xa, e, g_11be4, f, g, 0, 0);
}
