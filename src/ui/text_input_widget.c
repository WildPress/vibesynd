...
extern void draw_ui_text(char *s, unsigned short x, unsigned short y, unsigned char a4,
...
int text_input_widget(unsigned short x, unsigned short y, int width, unsigned short maxlen,
                 ...
                 unsigned char a8)
{
    ...
    draw_ui_text(buf, x, y, lineht, colour, font, kern, a8, 0, 0);
