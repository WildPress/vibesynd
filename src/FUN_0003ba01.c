...
#pragma aux __db_0003ba01_1 = "db 235" "db 20" "db 137" "db 240" "db 131" "db 224" "db 15" "db 80" "db 193" "db 238" "db 4" "call FUN_0003b9ee" "db 131" "db 196" "db 4" "db 136" "db 3" "db 75" "db 59" "db 93" "db 252" "db 117" "db 231" "db 139" "db 69" "db 24" "db 193" "db 248" parm [] modify exact [eax ebx ecx edx esi edi];
extern void __db_0003ba01_2(void);
#pragma aux __db_0003ba01_2 = "db 4" "db 131" "db 224" "db 15" "db 80" "db 198" "db 71" "db 5" "db 95" "call FUN_0003b9ee" "db 136" "db 71" "db 6" "db 139" "db 69" "db 24" "db 131" "db 196" "db 4" "db 131" "db 224" "db 15" "db 80" "call FUN_0003b9ee" "db 136" "db 71" "db 7" "db 198" parm [] modify exact [eax ebx ecx edx esi edi];
