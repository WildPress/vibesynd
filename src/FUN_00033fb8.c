 ...
 * Levers that closed the old g_5358 register wall (cont. 22): pointer-variable
 * decl `char **g_5358`; `base = g_5358;` declared BETWEEN col and index (the
 ...
 * gives the target's `mov edx,[g_5358]` + `lea ebx,[edx+eax]` with the movsx
