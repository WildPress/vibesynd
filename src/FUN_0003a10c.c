...
#pragma aux __rle2_a = "db 85" "db 139" "db 236" "db 131" "db 196" "db 252" "db 102" "db 161" "db 216" "db 189" "db 0" "db 0" "db 102" "db 137" "db 69" "db 254" "db 102" "db 161" "db 218" "db 189" "db 0" "db 0" "db 102" "db 137" "db 69" "db 252" "db 15" "db 183" "db 5" "db 220" "db 189" "db 0" "db 0" "db 131" "db 232" "db 6" "db 80" "db 255" "db 53" "db 112" "db 83" "db 0" "db 0" "db 255" "db 53" "db 208" "db 189" "db 0" "db 0" "call FUN_0003a7c4" "db 131" "db 196" "db 12" "db 139" "db 53" "db 104" "db 83" "db 0" "db 0" "db 139" "db 61" "db 112" "db 83" "db 0" "db 0" "db 102" "db 139" "db 93" modify exact [eax ebx ecx edx esi edi ebp];
...
#pragma aux FUN_0003a10c modify [eax ebx ecx edx esi edi ebp];
