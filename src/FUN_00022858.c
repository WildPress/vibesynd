/* frameless @ 0x22858: mission/map init sequence. Builds the g_5358 column table
   ...
   g_5378), clears + presents the screen buffer g_5368 (0x4993b/0x4987e), sets
   ...
   velocity pair from g_ab60/g_ad60[0x10], period 0xd48, misc bytes) and clamps
   g_1be34 to >= 0x12.
...
void FUN_00022858(void)
{
    ...
    g_1bc78 = 0x10;
    g_1bc74 = 0xd48;
    g_1bc70 = g_ab60[0x10] * 0x10 >> 8;
    g_1bc7a = 0x28;
    g_1bc72 = g_ad60[0x10] * 0x10 >> 8;
    g_1bc7b = 0xa;
    if (g_1be34 < 0x12)
        g_1be34 = 0x12;
}
