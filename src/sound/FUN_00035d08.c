/* frameless @ 0x35d08: driver/module load + init (int return, 1=ok 0=fail).
   ...
   registers the resource (FUN_398d7) -> handle g_11dec (-1 = fail+cleanup).
...
int FUN_00035d08(unsigned short a, unsigned short b, unsigned short c)
{
    unsigned short bb;

    bb = b;
    if ((g_11df0 = FUN_00018158(0x3d00, 0)) == 0)
        return 0;
    if ((g_11df4 = FUN_00017b48(g_11df0, 5, 0)) == 0)
        return 0;
    FUN_0003ab59(g_11df0);
    FUN_0003954c();
    g_11dec = FUN_000398d7(g_11df4);
    if (g_11dec == -1) {
        FUN_000395b6(0);
        return 0;
    }
    g_11dfc = (unsigned char __far *)FUN_00039994(g_11dec);
    ...
    if (FUN_000399b3(g_11dec, c, a, bb,
                     *(int __far *)(g_11dfc + 0x1c)) == 0) {
        FUN_000395b6(0);
        return 0;
    }
    FUN_000399bd(g_11dec, c, a, bb, *(int __far *)(g_11dfc + 0x1c));
    return 1;
}
