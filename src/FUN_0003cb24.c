/* C runtime: stream mode/reopen helper @ 0x3cb24 (CLIB3S, Watcom 9.5). Framed
   ...
   &=0xcf), lazily allocates the file's device via FUN_0003d894 when the fd slot (+8)
...
#pragma aux __FUN_0003cb24_0 = "db 83" "db 86" "db 87" "db 85" "db 137" "db 229" "db 131" "db 236" "db 4" "db 139" "db 93" "db 20" "db 139" "db 115" "db 12" "db 131" "db 230" "db 48" "db 128" "db 99" "db 12" "db 207" "db 137" "db 117" "db 252" "db 131" "db 123" "db 8" "db 0" "db 117" "db 9" "db 83" "call FUN_0003d894" "db 131" "db 196" "db 4" "db 49" "db 255" "db 246" "db 67" "db 13" "db 4" "db 116" "db 13" "db 128" "db 99" "db 13" "db 251" "db 191" "db 1" "db 0" "db 0" "db 0" "db 128" "db 75" "db 13" "db 1" "db 104" "db 194" "db 243" "db 2" "db 0" "db 255" "db 117" "db 28" "db 255" modify exact [eax ebx ecx edx esi edi ebp];
