/* frameless @ 0x1c178: spawn into the g_15e70 pool (128 records of 0x1e bytes). For each
   ...
   FUN_00026e18(p, x, y, z), then set type/frame +0x19 = 0x29 and link +0x1c = param_4.
...
extern void FUN_00026e18(unsigned char *p, int x, int y, int z);
void FUN_0001c178(unsigned short param_1, unsigned short param_2, unsigned short param_3, unsigned short param_4)
{
    ...
    do {
        if (p[0x18] == 0) {
            ...
            *(unsigned short *)(p + 0x12) = 0xffff;
            FUN_00026e18(p, *(short *)(p + 4), *(short *)(p + 6), *(short *)(p + 8));
            p[0x19] = 0x29;
