...
SHIMS="sopen,read,write,close,lseek,tell,set_video_mode,upload_palette,vga_planar_present,present_frame_planar,present_patch_gated,clear_vga_screen,save_cursor_bg,restore_cursor_bg,save_sprite_bg,restore_sprite_bg,wait_vsync,reset_gfx_write_mode,flic_load_palette,os_getmem,dpmi_dos_alloc_paras,brk,heap_grow,malloc,nmalloc,free,nfree,int386,poll_key,frame_throttle,install_timer_isr,uninstall_timer_isr,reprogram_pit_ch0"
